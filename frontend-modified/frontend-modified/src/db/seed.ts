...
const FAQ_ITEMS: FAQItem[] = [
  ...
  { id: 'f1',  section: 'About Our Products',  order: 1,  createdAt: new Date(),
    ...
    answer: 'Modafinil is a wakefulness-promoting drug originally developed to treat narcolepsy and other sleep disorders. It works primarily by inhibiting dopamine reuptake, increasing extracellular dopamine in the brain\'s wakefulness centers. Unlike amphetamines, it selectively activates the brain\'s arousal systems without broadly stimulating the nervous system, resulting in cleaner, more focused wakefulness without significant side effects.' },
  { id: 'f2',  section: 'About Our Products',  order: 2,  createdAt: new Date(),
    ...
    answer: 'Standard modafinil (Modalert, Modvigil) is a racemic mixture containing both R and S enantiomers. Armodafinil (Waklert, Artvigil) contains only the R-enantiomer — the more pharmacologically active form. Armodafinil is considered "cleaner" with a more consistent plasma concentration throughout the day, often providing 15+ hours of effects vs 12 hours for modafinil. Many users find armodafinil more potent at lower doses.' },
  { id: 'f3',  section: 'About Our Products',  order: 3,  createdAt: new Date(),
    question: 'What is the difference between Modalert and Modvigil?',
    answer: 'Both contain identical active ingredients (modafinil 200mg) but are manufactured by different companies. Modalert is made by Sun Pharmaceuticals, one of the world\'s largest generic drug companies. Modvigil is made by HAB Pharmaceuticals. Anecdotally, many users report Modalert feels slightly stronger/faster onset, while Modvigil is smoother. The difference is subtle — most users are satisfied with either. Modvigil is more affordable.' },
  { id: 'f4',  section: 'About Our Products',  order: 4,  createdAt: new Date(),
    question: 'Is modafinil safe?',
    answer: 'Modafinil has over 30 years of clinical use and one of the best safety profiles of any cognitive enhancer. The most common side effects are headache, nausea, and insomnia if taken too late in the day — all of which are dose-dependent and preventable. Serious adverse effects are rare. We recommend starting with 100mg (half a tablet) to assess your individual response.' },
  { id: 'f5',  section: 'About Our Products',  order: 5,  createdAt: new Date(),
    question: 'Are your products genuine pharmaceutical grade?',
    answer: 'Yes. We source exclusively from licensed distributors of Sun Pharmaceuticals and HAB Pharmaceuticals — the same companies that supply hospitals and pharmacies worldwide. Each manufacturer operates WHO-GMP certified facilities. We can provide certificates of authenticity upon request.' },
  // Ordering & Payment
  { id: 'f6',  section: 'Ordering & Payment', order: 1,  createdAt: new Date(),
    question: 'What payment methods do you accept?',
    answer: 'We accept Bitcoin (BTC), Ethereum (ETH), Zelle, and cash by mail. Cryptocurrency payments receive an automatic 15% discount, and Zelle receives 10% off. Crypto is our preferred payment method as it provides the fastest processing and greatest privacy.' },
  { id: 'f7',  section: 'Ordering & Payment', order: 2,  createdAt: new Date(),
    question: 'Do I need a prescription?',
    answer: 'We sell our products for research and educational purposes. No prescription is required to place an order on our website. We are not a licensed pharmacy and do not provide medical advice. We strongly recommend consulting a healthcare professional if you have any medical conditions.' },
  { id: 'f8',  section: 'Ordering & Payment', order: 3,  createdAt: new Date(),
    question: 'Is my personal information secure?',
    answer: 'Absolutely. We use 256-bit SSL encryption for all transactions and store minimal personal data. We never sell customer data to third parties. For maximum privacy, use Bitcoin or Ethereum — these transactions provide the highest level of financial privacy.' },
  { id: 'f9',  section: 'Ordering & Payment', order: 4,  createdAt: new Date(),
    question: 'Can I use a coupon code?',
    answer: 'Yes! Enter your coupon code during checkout. New customers can use WELCOME10 for 10% off their first order. Sign up for our newsletter to receive exclusive promo codes.' },
  // Shipping & Delivery
  { id: 'f10', section: 'Shipping & Delivery', order: 1, createdAt: new Date(),
    question: 'How long does shipping take?',
    answer: 'Standard shipping takes 7–14 business days within the US. Express shipping (3–7 business days) is available for $19.99. International orders typically take 10–21 business days depending on destination and customs.' },
  { id: 'f11', section: 'Shipping & Delivery', order: 2, createdAt: new Date(),
    question: 'Is packaging discreet?',
    answer: 'Yes, completely. All orders ship in plain, unmarked packaging with no reference to the product, company name, or website on the outside. Return address uses a generic business name. The product is packed to prevent any visible outline through the packaging.' },
  { id: 'f12', section: 'Shipping & Delivery', order: 3, createdAt: new Date(),
    question: 'Do you ship internationally?',
    answer: 'Yes, we ship to most countries worldwide. However, please be aware of your local regulations. We cannot be responsible for packages seized by customs. In the event of a customs seizure, we will reship your order free of charge — no questions asked.' },
  { id: 'f13', section: 'Shipping & Delivery', order: 4, createdAt: new Date(),
    question: 'What is your reshipment policy?',
    answer: 'If your package is seized by customs or lost in transit, we will reship your order at no cost. To qualify for reshipment, simply contact our support team within 30 days of the estimated delivery date. We\'ve reshipped hundreds of packages and stand fully behind our delivery guarantee.' },
  { id: 'f14', section: 'Shipping & Delivery', order: 5, createdAt: new Date(),
    question: 'How do I track my order?',
    answer: 'A tracking number will be emailed to you within 48 hours of shipment. You can also track your order directly from your account page. If you don\'t receive tracking information within 72 hours, please contact support.' },
  // Usage & Dosing
  { id: 'f15', section: 'Usage & Dosing', order: 1, createdAt: new Date(),
    question: 'What is the recommended dose?',
    answer: 'For modafinil: 100–200mg taken in the morning. For armodafinil: 75–150mg. Always start with the lower dose to assess your response. Taking more than recommended doesn\'t provide proportionally better effects and increases the risk of side effects.' },
  { id: 'f16', section: 'Usage & Dosing', order: 2, createdAt: new Date(),
    question: 'How often should I take modafinil?',
    answer: 'We recommend using modafinil no more than 3–4 days per week to maintain sensitivity and preserve your natural sleep architecture. Many high performers use it only on demanding days — important presentations, exam periods, or critical deadlines.' },
  { id: 'f17', section: 'Usage & Dosing', order: 3, createdAt: new Date(),
    question: 'What should I avoid while taking modafinil?',
    answer: 'Avoid taking modafinil after noon (to prevent sleep disruption), combining with alcohol (modafinil can mask intoxication), or on days when you plan to have a full night\'s sleep earlier than 8–9 hours from dosing. Birth control pills may be less effective when taking modafinil — use backup contraception.' },
];
