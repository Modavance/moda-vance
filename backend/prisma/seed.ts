...
Try each product on separate days and note how each affects your focus, mood, and productivity. The result: firsthand knowledge of which product works best for your unique neurochemistry.`,
  ...
  await prisma.faqItem.createMany({
    data: [
      ...
      // Ordering & Payment
      { section: 'Ordering & Payment', order: 1, question: 'What payment methods do you accept?', answer: 'We accept Bitcoin (BTC), Ethereum (ETH), Zelle, and Bill payment. Cryptocurrency payments receive an automatic 15% discount and provide the fastest order processing. Zelle payments receive a 10% discount.' },
