          ...
          <>
            ...
            {freeShippingRemaining > 0 && (
              <div className="px-6 py-3 bg-blue-50 border-b border-blue-100">
                <div className="flex justify-between text-xs font-medium text-blue-700 mb-1.5">
            ...
            {shipping === 0 && (
              <div className="px-6 py-2.5 bg-emerald-50 border-b border-emerald-100 text-xs font-semibold text-emerald-700 flex items-center gap-1.5">
                <Package className="w-3.5 h-3.5" /> You qualify for FREE shipping!
              </div>
            )}
