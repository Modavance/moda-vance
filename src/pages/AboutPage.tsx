      ...
      <div className="gradient-hero py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg text-slate-300 leading-relaxed">
            Founded in 2023 by a group of biohackers, pharmacists, and tech professionals, ModaVance was born from personal experience with the challenges of sourcing high-quality cognitive enhancers primarily in the US and EU market.
          </p>
        </div>
      </div>
